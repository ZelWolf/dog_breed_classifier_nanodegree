...
def get_pet_labels(image_dir):
    ...
    # Processes each filename in the filename_list to extract the pet image label
    for idx in range(0, len(filename_list), 1):
        
        # Skips hidden files (like .DS_Store of Mac OSX)
        if filename_list[idx][0] != ".":
            ...
            # pet label - otherwise print warning message
    ...
    # Return the results_dic dictionary that you created with this function
    return results_dic