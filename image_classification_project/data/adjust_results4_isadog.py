...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # Adds dogname to dogsnames_dic if it doesn't already exist in the dic
            if line not in dognames_dic:
                dognames_dic[line] = 1
            else:
                print("**Warning: Duplicate dognames in", dogfile, ":", line)
                
            # Reads in next line in file to be used with while loop
            line = infile.readline()
